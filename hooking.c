...
/*   Updated: 2025/03/07 17:51:10 by huahmad          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (key_code == 4)
		ft_zoomin(((double)x / fractol->width * 1000 - 500), ((double)y
				/ fractol->height * 1000 - 500), fractol);
	else if (key_code == 5)
		ft_zoomout(((double)x / fractol->width * 1000 - 500), ((double)y
				/ fractol->height * 1000 - 500), fractol);
